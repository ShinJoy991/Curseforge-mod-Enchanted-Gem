...
public class Config {
    ...
    private static final ForgeConfigSpec.BooleanValue UpdateItem = BUILDER
            .comment("Whether to update item lore when player join world and when open container, turn this on to update old item lore or if you want edit value while running, turn off to save some" +
                    " task time")
            .define("Update_Item", false);
    static {
    ...
    public static boolean UPDATE_ITEM;
